[Skip to content](https://nodejs.org/api/buffer.html#apicontent)
...
- [Buffer](https://nodejs.org/api/buffer.html#buffer)
  - [Buffers and character encodings](https://nodejs.org/api/buffer.html#buffers-and-character-encodings)
  - [Buffers and TypedArrays](https://nodejs.org/api/buffer.html#buffers-and-typedarrays)
  - [Buffers and iteration](https://nodejs.org/api/buffer.html#buffers-and-iteration)
  - [Class: `Blob`](https://nodejs.org/api/buffer.html#class-blob)
    - [`new buffer.Blob([sources[, options]])`](https://nodejs.org/api/buffer.html#new-bufferblobsources-options)
    - [`blob.arrayBuffer()`](https://nodejs.org/api/buffer.html#blobarraybuffer)
      - [`blob.bytes()`](https://nodejs.org/api/buffer.html#blobbytes)
    - [`blob.size`](https://nodejs.org/api/buffer.html#blobsize)
    - [`blob.slice([start[, end[, type]]])`](https://nodejs.org/api/buffer.html#blobslicestart-end-type)
    - [`blob.stream()`](https://nodejs.org/api/buffer.html#blobstream)
    - [`blob.text()`](https://nodejs.org/api/buffer.html#blobtext)
    - [`blob.type`](https://nodejs.org/api/buffer.html#blobtype)
    - [`Blob` objects and `MessageChannel`](https://nodejs.org/api/buffer.html#blob-objects-and-messagechannel)
  - [Class: `Buffer`](https://nodejs.org/api/buffer.html#class-buffer)
    - [Static method: `Buffer.alloc(size[, fill[, encoding]])`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding)
    ...
    - [Static method: `Buffer.byteLength(string[, encoding])`](https://nodejs.org/api/buffer.html#static-method-bufferbytelengthstring-encoding)
    - [Static method: `Buffer.compare(buf1, buf2)`](https://nodejs.org/api/buffer.html#static-method-buffercomparebuf1-buf2)
    - [Static method: `Buffer.concat(list[, totalLength])`](https://nodejs.org/api/buffer.html#static-method-bufferconcatlist-totallength)
    - [Static method: `Buffer.copyBytesFrom(view[, offset[, length]])`](https://nodejs.org/api/buffer.html#static-method-buffercopybytesfromview-offset-length)
    - [Static method: `Buffer.from(array)`](https://nodejs.org/api/buffer.html#static-method-bufferfromarray)
    - [Static method: `Buffer.from(arrayBuffer[, byteOffset[, length]])`](https://nodejs.org/api/buffer.html#static-method-bufferfromarraybuffer-byteoffset-length)
    - [Static method: `Buffer.from(buffer)`](https://nodejs.org/api/buffer.html#static-method-bufferfrombuffer)
    - [Static method: `Buffer.from(object[, offsetOrEncoding[, length]])`](https://nodejs.org/api/buffer.html#static-method-bufferfromobject-offsetorencoding-length)
    - [Static method: `Buffer.from(string[, encoding])`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding)
    - [Static method: `Buffer.isBuffer(obj)`](https://nodejs.org/api/buffer.html#static-method-bufferisbufferobj)
    - [Static method: `Buffer.isEncoding(encoding)`](https://nodejs.org/api/buffer.html#static-method-bufferisencodingencoding)
    - [`Buffer.poolSize`](https://nodejs.org/api/buffer.html#bufferpoolsize)
    - [`buf[index]`](https://nodejs.org/api/buffer.html#bufindex)
    - [`buf.buffer`](https://nodejs.org/api/buffer.html#bufbuffer)
    - [`buf.byteOffset`](https://nodejs.org/api/buffer.html#bufbyteoffset)
    - [`buf.compare(target[, targetStart[, targetEnd[, sourceStart[, sourceEnd]]]])`](https://nodejs.org/api/buffer.html#bufcomparetarget-targetstart-targetend-sourcestart-sourceend)
    ...
    - [`buf.entries()`](https://nodejs.org/api/buffer.html#bufentries)
    - [`buf.equals(otherBuffer)`](https://nodejs.org/api/buffer.html#bufequalsotherbuffer)
    - [`buf.fill(value[, offset[, end]][, encoding])`](https://nodejs.org/api/buffer.html#buffillvalue-offset-end-encoding)
    - [`buf.includes(value[, byteOffset][, encoding])`](https://nodejs.org/api/buffer.html#bufincludesvalue-byteoffset-encoding)
    - [`buf.indexOf(value[, byteOffset][, encoding])`](https://nodejs.org/api/buffer.html#bufindexofvalue-byteoffset-encoding)
    - [`buf.keys()`](https://nodejs.org/api/buffer.html#bufkeys)
    - [`buf.lastIndexOf(value[, byteOffset][, encoding])`](https://nodejs.org/api/buffer.html#buflastindexofvalue-byteoffset-encoding)
    - [`buf.length`](https://nodejs.org/api/buffer.html#buflength)
    - [`buf.parent`](https://nodejs.org/api/buffer.html#bufparent)
    - [`buf.readBigInt64BE([offset])`](https://nodejs.org/api/buffer.html#bufreadbigint64beoffset)
    - [`buf.readBigInt64LE([offset])`](https://nodejs.org/api/buffer.html#bufreadbigint64leoffset)
    - [`buf.readBigUInt64BE([offset])`](https://nodejs.org/api/buffer.html#bufreadbiguint64beoffset)
    - [`buf.readBigUInt64LE([offset])`](https://nodejs.org/api/buffer.html#bufreadbiguint64leoffset)
    - [`buf.readDoubleBE([offset])`](https://nodejs.org/api/buffer.html#bufreaddoublebeoffset)
    - [`buf.readDoubleLE([offset])`](https://nodejs.org/api/buffer.html#bufreaddoubleleoffset)
    - [`buf.readFloatBE([offset])`](https://nodejs.org/api/buffer.html#bufreadfloatbeoffset)
    - [`buf.readFloatLE([offset])`](https://nodejs.org/api/buffer.html#bufreadfloatleoffset)
    - [`buf.readInt8([offset])`](https://nodejs.org/api/buffer.html#bufreadint8offset)
    - [`buf.readInt16BE([offset])`](https://nodejs.org/api/buffer.html#bufreadint16beoffset)
    - [`buf.readInt16LE([offset])`](https://nodejs.org/api/buffer.html#bufreadint16leoffset)
    - [`buf.readInt32BE([offset])`](https://nodejs.org/api/buffer.html#bufreadint32beoffset)
    - [`buf.readInt32LE([offset])`](https://nodejs.org/api/buffer.html#bufreadint32leoffset)
    - [`buf.readIntBE(offset, byteLength)`](https://nodejs.org/api/buffer.html#bufreadintbeoffset-bytelength)
    - [`buf.readIntLE(offset, byteLength)`](https://nodejs.org/api/buffer.html#bufreadintleoffset-bytelength)
    - [`buf.readUInt8([offset])`](https://nodejs.org/api/buffer.html#bufreaduint8offset)
    - [`buf.readUInt16BE([offset])`](https://nodejs.org/api/buffer.html#bufreaduint16beoffset)
    - [`buf.readUInt16LE([offset])`](https://nodejs.org/api/buffer.html#bufreaduint16leoffset)
    - [`buf.readUInt32BE([offset])`](https://nodejs.org/api/buffer.html#bufreaduint32beoffset)
    - [`buf.readUInt32LE([offset])`](https://nodejs.org/api/buffer.html#bufreaduint32leoffset)
    - [`buf.readUIntBE(offset, byteLength)`](https://nodejs.org/api/buffer.html#bufreaduintbeoffset-bytelength)
    - [`buf.readUIntLE(offset, byteLength)`](https://nodejs.org/api/buffer.html#bufreaduintleoffset-bytelength)
    - [`buf.subarray([start[, end]])`](https://nodejs.org/api/buffer.html#bufsubarraystart-end)
    - [`buf.slice([start[, end]])`](https://nodejs.org/api/buffer.html#bufslicestart-end)
    - [`buf.swap16()`](https://nodejs.org/api/buffer.html#bufswap16)
    ...
    - [`buf.toString([encoding[, start[, end]]])`](https://nodejs.org/api/buffer.html#buftostringencoding-start-end)
    - [`buf.values()`](https://nodejs.org/api/buffer.html#bufvalues)
    ...
    - [`buf.writeBigUInt64BE(value[, offset])`](https://nodejs.org/api/buffer.html#bufwritebiguint64bevalue-offset)
    - [`buf.writeBigUInt64LE(value[, offset])`](https://nodejs.org/api/buffer.html#bufwritebiguint64levalue-offset)
    ...
    - [`buf.writeIntBE(value, offset, byteLength)`](https://nodejs.org/api/buffer.html#bufwriteintbevalue-offset-bytelength)
    - [`buf.writeIntLE(value, offset, byteLength)`](https://nodejs.org/api/buffer.html#bufwriteintlevalue-offset-bytelength)
    ...
    - [`buf.writeUIntBE(value, offset, byteLength)`](https://nodejs.org/api/buffer.html#bufwriteuintbevalue-offset-bytelength)
    - [`buf.writeUIntLE(value, offset, byteLength)`](https://nodejs.org/api/buffer.html#bufwriteuintlevalue-offset-bytelength)
    - [`new Buffer(array)`](https://nodejs.org/api/buffer.html#new-bufferarray)
    - [`new Buffer(arrayBuffer[, byteOffset[, length]])`](https://nodejs.org/api/buffer.html#new-bufferarraybuffer-byteoffset-length)
    - [`new Buffer(buffer)`](https://nodejs.org/api/buffer.html#new-bufferbuffer)
    - [`new Buffer(size)`](https://nodejs.org/api/buffer.html#new-buffersize)
    - [`new Buffer(string[, encoding])`](https://nodejs.org/api/buffer.html#new-bufferstring-encoding)
  - [Class: `File`](https://nodejs.org/api/buffer.html#class-file)
    - [`new buffer.File(sources, fileName[, options])`](https://nodejs.org/api/buffer.html#new-bufferfilesources-filename-options)
    - [`file.name`](https://nodejs.org/api/buffer.html#filename)
    - [`file.lastModified`](https://nodejs.org/api/buffer.html#filelastmodified)
  - [`node:buffer` module APIs](https://nodejs.org/api/buffer.html#nodebuffer-module-apis)
    - [`buffer.atob(data)`](https://nodejs.org/api/buffer.html#bufferatobdata)
    - [`buffer.btoa(data)`](https://nodejs.org/api/buffer.html#bufferbtoadata)
    ...
    - [Buffer constants](https://nodejs.org/api/buffer.html#buffer-constants)
      - [`buffer.constants.MAX_LENGTH`](https://nodejs.org/api/buffer.html#bufferconstantsmax_length)
      - [`buffer.constants.MAX_STRING_LENGTH`](https://nodejs.org/api/buffer.html#bufferconstantsmax_string_length)
  - [`Buffer.from()`, `Buffer.alloc()`, and `Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#bufferfrom-bufferalloc-and-bufferallocunsafe)
    - [The `--zero-fill-buffers` command-line option](https://nodejs.org/api/buffer.html#the---zero-fill-buffers-command-line-option)
    - [What makes `Buffer.allocUnsafe()` and `Buffer.allocUnsafeSlow()` "unsafe"?](https://nodejs.org/api/buffer.html#what-makes-bufferallocunsafe-and-bufferallocunsafeslow-unsafe)
...
[`Buffer.prototype.slice()`](https://nodejs.org/api/buffer.html#bufslicestart-end) creates a view over the existing `Buffer`
...
the behavior of [`Buffer.prototype.slice()`](https://nodejs.org/api/buffer.html#bufslicestart-end) on both `Buffer` s
and other `TypedArray` s and should be preferred.
- [`buf.toString()`](https://nodejs.org/api/buffer.html#buftostringencoding-start-end) is incompatible with its `TypedArray` equivalent.
- A number of methods, e.g. [`buf.indexOf()`](https://nodejs.org/api/buffer.html#bufindexofvalue-byteoffset-encoding), support additional arguments.
...
`.buffer` property in the same way. [`Buffer.from()`](https://nodejs.org/api/buffer.html#static-method-bufferfromarraybuffer-byteoffset-length)
...
- [`Buffer.from(buffer)`](https://nodejs.org/api/buffer.html#static-method-bufferfrombuffer)
- [`Buffer.from(arrayBuffer[, byteOffset[, length]])`](https://nodejs.org/api/buffer.html#static-method-bufferfromarraybuffer-byteoffset-length)
...
Additionally, the [`buf.values()`](https://nodejs.org/api/buffer.html#bufvalues), [`buf.keys()`](https://nodejs.org/api/buffer.html#bufkeys), and
[`buf.entries()`](https://nodejs.org/api/buffer.html#bufentries) methods can be used to create iterators.
...
A [<Blob>](https://nodejs.org/api/buffer.html#class-blob) encapsulates immutable, raw data that can be safely shared across
...
Once a [<Blob>](https://nodejs.org/api/buffer.html#class-blob) object is created, it can be sent via `MessagePort` to multiple
...
- `fill` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) \| [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) \| [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) A value to pre-fill the new `Buffer`
with. **Default:** `0`.
...
[`buffer.constants.MAX_LENGTH`](https://nodejs.org/api/buffer.html#bufferconstantsmax_length) or smaller than 0, [`ERR_OUT_OF_RANGE`](https://nodejs.org/api/errors.html#err_out_of_range)
is thrown.

If `fill` is specified, the allocated `Buffer` will be initialized by calling
[`buf.fill(fill)`](https://nodejs.org/api/buffer.html#buffillvalue-offset-end-encoding).
...
initialized by calling [`buf.fill(fill, encoding)`](https://nodejs.org/api/buffer.html#buffillvalue-offset-end-encoding).
...
Calling [`Buffer.alloc()`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding) can be measurably slower than the alternative
[`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) but ensures that the newly created `Buffer` instance
...
_may contain sensitive data_. Use [`Buffer.alloc()`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding) instead to initialize
...
size [`Buffer.poolSize`](https://nodejs.org/api/buffer.html#bufferpoolsize) that is used as a pool for the fast allocation of new
`Buffer` instances created using [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize), [`Buffer.from(array)`](https://nodejs.org/api/buffer.html#static-method-bufferfromarray),
[`Buffer.from(string)`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding), and [`Buffer.concat()`](https://nodejs.org/api/buffer.html#static-method-bufferconcatlist-totallength) only when `size` is less than
`Buffer.poolSize >>> 1` (floor of [`Buffer.poolSize`](https://nodejs.org/api/buffer.html#bufferpoolsize) divided by two).
...
`Buffer` pool if `size` is less than or equal to half [`Buffer.poolSize`](https://nodejs.org/api/buffer.html#bufferpoolsize). The
difference is subtle but can be important when an application requires the
additional performance that [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) provides.
...
The underlying memory for `Buffer` instances created in this way is _not_
_initialized_. The contents of the newly created `Buffer` are unknown and
_may contain sensitive data_. Use [`buf.fill(0)`](https://nodejs.org/api/buffer.html#buffillvalue-offset-end-encoding) to initialize
such `Buffer` instances with zeroes.

When using [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) to allocate new `Buffer` instances,
...
- `buf1` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
- `buf2` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
...
comparison. See [`buf.compare()`](https://nodejs.org/api/buffer.html#bufcomparetarget-targetstart-targetend-sourcestart-sourceend) for details.

Compares `buf1` to `buf2`, typically for the purpose of sorting arrays of
`Buffer` instances. This is equivalent to calling
[`buf1.compare(buf2)`](https://nodejs.org/api/buffer.html#bufcomparetarget-targetstart-targetend-sourcestart-sourceend).
...
- `list` [<Buffer\[\]>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) List of `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)
...
[`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) does.
...
[`Buffer.copyBytesFrom()`](https://nodejs.org/api/buffer.html#static-method-buffercopybytesfromview-offset-length).

A `TypeError` will be thrown if `array` is not an `Array` or another type
appropriate for `Buffer.from()` variants.

`Buffer.from(array)` and [`Buffer.from(string)`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding) may also use the internal
`Buffer` pool like [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) does.
...
- `buffer` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) An existing `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) from
which to copy data.
- Returns: [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer)
...
[`Buffer.from(string)`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding) may also use the internal `Buffer` pool like
[`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) does.
...
- `target` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) with which to
compare `buf`.
...
(not inclusive). **Default:** [`buf.length`](https://nodejs.org/api/buffer.html#buflength).
...
[`ERR_OUT_OF_RANGE`](https://nodejs.org/api/errors.html#err_out_of_range) is thrown if `targetStart < 0`, `sourceStart < 0`,
...
- `target` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) to copy into.
- `targetStart` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) The offset within `target` at which to begin
writing. **Default:** `0`.
...
inclusive). **Default:** [`buf.length`](https://nodejs.org/api/buffer.html#buflength).
...
- `otherBuffer` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) with which to
compare `buf`.
- Returns: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type)

Returns `true` if both `buf` and `otherBuffer` have exactly the same bytes,
`false` otherwise. Equivalent to
[`buf.compare(otherBuffer) === 0`](https://nodejs.org/api/buffer.html#bufcomparetarget-targetstart-targetend-sourcestart-sourceend).
...
- `value` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) \| [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) \| [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) The value with which to fill `buf`.
...
**Default:** `0`.
- `end` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) Where to stop filling `buf` (not inclusive). **Default:** [`buf.length`](https://nodejs.org/api/buffer.html#buflength).
...
**Default:** `'utf8'`.
- Returns: [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) A reference to `buf`.
...
Equivalent to [`buf.indexOf() !== -1`](https://nodejs.org/api/buffer.html#bufindexofvalue-byteoffset-encoding).
...
To compare a partial `Buffer`, use [`buf.subarray`](https://nodejs.org/api/buffer.html#bufsubarraystart-end).
...
Identical to [`buf.indexOf()`](https://nodejs.org/api/buffer.html#bufindexofvalue-byteoffset-encoding), except the last occurrence of `value` is found
...
[Stability: 0](https://nodejs.org/api/documentation.html#stability-index) \- Deprecated: Use [`buf.buffer`](https://nodejs.org/api/buffer.html#bufbuffer) instead.
...
**Default:** [`buf.length`](https://nodejs.org/api/buffer.html#buflength).
- Returns: [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer)

Returns a new `Buffer` that references the same memory as the original, but
offset and cropped by the `start` and `end` indexes.

Specifying `end` greater than [`buf.length`](https://nodejs.org/api/buffer.html#buflength) will return the same result as
that of `end` equal to [`buf.length`](https://nodejs.org/api/buffer.html#buflength).
...
[Stability: 0](https://nodejs.org/api/documentation.html#stability-index) \- Deprecated: Use [`buf.subarray`](https://nodejs.org/api/buffer.html#bufsubarraystart-end) instead.
...
byte order _in-place_. Throws [`ERR_INVALID_BUFFER_SIZE`](https://nodejs.org/api/errors.html#err_invalid_buffer_size) if [`buf.length`](https://nodejs.org/api/buffer.html#buflength)
...
Throws [`ERR_INVALID_BUFFER_SIZE`](https://nodejs.org/api/errors.html#err_invalid_buffer_size) if [`buf.length`](https://nodejs.org/api/buffer.html#buflength) is not a multiple of 8.
...
as [`buffer.constants.MAX_STRING_LENGTH`](https://nodejs.org/api/buffer.html#bufferconstantsmax_string_length).
...
[Stability: 0](https://nodejs.org/api/documentation.html#stability-index) \- Deprecated: Use [`Buffer.from(array)`](https://nodejs.org/api/buffer.html#static-method-bufferfromarray) instead.
...
See [`Buffer.from(array)`](https://nodejs.org/api/buffer.html#static-method-bufferfromarray).
...
[Stability: 0](https://nodejs.org/api/documentation.html#stability-index) \- Deprecated: Use
[`Buffer.from(arrayBuffer[, byteOffset[, length]])`](https://nodejs.org/api/buffer.html#static-method-bufferfromarraybuffer-byteoffset-length)
instead.
...
[Stability: 0](https://nodejs.org/api/documentation.html#stability-index) \- Deprecated: Use [`Buffer.from(buffer)`](https://nodejs.org/api/buffer.html#static-method-bufferfrombuffer) instead.

- `buffer` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) An existing `Buffer` or [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) from
which to copy data.

See [`Buffer.from(buffer)`](https://nodejs.org/api/buffer.html#static-method-bufferfrombuffer).
...
[Stability: 0](https://nodejs.org/api/documentation.html#stability-index) \- Deprecated: Use [`Buffer.alloc()`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding) instead (also see
[`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize)).

- `size` [<integer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type) The desired length of the new `Buffer`.

See [`Buffer.alloc()`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding) and [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize). This variant of the
constructor is equivalent to [`Buffer.alloc()`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding).
...
[Stability: 0](https://nodejs.org/api/documentation.html#stability-index) \- Deprecated:
Use [`Buffer.from(string[, encoding])`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding) instead.

- `string` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) String to encode.
- `encoding` [<string>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) The encoding of `string`. **Default:** `'utf8'`.

See [`Buffer.from(string[, encoding])`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding).
...
- Extends: [<Blob>](https://nodejs.org/api/buffer.html#class-blob)

A [<File>](https://nodejs.org/api/buffer.html#class-file) provides information about files.

#### `new buffer.File(sources, fileName[, options])`[\#](https://nodejs.org/api/buffer.html\#new-bufferfilesources-filename-options)

Added in: v19.2.0, v18.13.0

- `sources` [<string\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type) \| [<ArrayBuffer\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) \| [<TypedArray\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) \| [<DataView\[\]>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView) \| [<Blob\[\]>](https://nodejs.org/api/buffer.html#class-blob) \| [<File\[\]>](https://nodejs.org/api/buffer.html#class-file)
An array of string, [<ArrayBuffer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer), [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray), [<DataView>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/DataView), [<File>](https://nodejs.org/api/buffer.html#class-file), or [<Blob>](https://nodejs.org/api/buffer.html#class-blob)
...
[Stability: 3](https://nodejs.org/api/documentation.html#stability-index) \- Legacy. Use `Buffer.from(data, 'base64')` instead.
...
[Stability: 3](https://nodejs.org/api/documentation.html#stability-index) \- Legacy. Use `buf.toString('base64')` instead.
...
- `input` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<ArrayBuffer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) \| [<TypedArray>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/TypedArray) The input to validate.
- Returns: [<boolean>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Boolean_type)
...
[`util.inspect()`](https://nodejs.org/api/util.html#utilinspectobject-options) for more details on `buf.inspect()` behavior.
...
An alias for [`buffer.constants.MAX_LENGTH`](https://nodejs.org/api/buffer.html#bufferconstantsmax_length).
...
An alias for [`buffer.constants.MAX_STRING_LENGTH`](https://nodejs.org/api/buffer.html#bufferconstantsmax_string_length).
...
Resolves a `'blob:nodedata:...'` an associated [<Blob>](https://nodejs.org/api/buffer.html#class-blob) object registered using
...
- `source` [<Buffer>](https://nodejs.org/api/buffer.html#class-buffer) \| [<Uint8Array>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) A `Buffer` or `Uint8Array` instance.
...
This value is also available as [`buffer.kMaxLength`](https://nodejs.org/api/buffer.html#bufferkmaxlength).
...
initialized by using either [`buf.fill(0)`](https://nodejs.org/api/buffer.html#buffillvalue-offset-end-encoding) or by writing to the
...
and replaced by separate `Buffer.from()`, [`Buffer.alloc()`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding), and
[`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) methods.

_Developers should migrate all existing uses of the `new Buffer()` constructors_
_to one of these new APIs._

- [`Buffer.from(array)`](https://nodejs.org/api/buffer.html#static-method-bufferfromarray) returns a new `Buffer` that _contains a copy_ of the
provided octets.
- [`Buffer.from(arrayBuffer[, byteOffset[, length]])`](https://nodejs.org/api/buffer.html#static-method-bufferfromarraybuffer-byteoffset-length)
returns a new `Buffer` that _shares the same allocated memory_ as the given
[<ArrayBuffer>](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer).
- [`Buffer.from(buffer)`](https://nodejs.org/api/buffer.html#static-method-bufferfrombuffer) returns a new `Buffer` that _contains a copy_ of the
contents of the given `Buffer`.
- [`Buffer.from(string[, encoding])`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding) returns a new
`Buffer` that _contains a copy_ of the provided string.
- [`Buffer.alloc(size[, fill[, encoding]])`](https://nodejs.org/api/buffer.html#static-method-bufferallocsize-fill-encoding) returns a new
initialized `Buffer` of the specified size. This method is slower than
[`Buffer.allocUnsafe(size)`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) but guarantees that newly
...
- [`Buffer.allocUnsafe(size)`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) and
[`Buffer.allocUnsafeSlow(size)`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafeslowsize) each return a
new uninitialized `Buffer` of the specified `size`. Because the `Buffer` is
uninitialized, the allocated segment of memory might contain old data that is
potentially sensitive.

`Buffer` instances returned by [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize), [`Buffer.from(string)`](https://nodejs.org/api/buffer.html#static-method-bufferfromstring-encoding),
[`Buffer.concat()`](https://nodejs.org/api/buffer.html#static-method-bufferconcatlist-totallength) and [`Buffer.from(array)`](https://nodejs.org/api/buffer.html#static-method-bufferfromarray) _may_ be allocated off a shared
internal memory pool if `size` is less than or equal to half [`Buffer.poolSize`](https://nodejs.org/api/buffer.html#bufferpoolsize).
Instances returned by [`Buffer.allocUnsafeSlow()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafeslowsize) _never_ use the shared internal
memory pool.
...
default. Without the option, buffers created with [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) and
[`Buffer.allocUnsafeSlow()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafeslowsize) are not zero-filled. Use of this flag can have a
...
When calling [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) and [`Buffer.allocUnsafeSlow()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafeslowsize), the
segment of allocated memory is _uninitialized_ (it is not zeroed-out). While
this design makes the allocation of memory quite fast, the allocated segment of
memory might contain old data that is potentially sensitive. Using a `Buffer`
created by [`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize) without _completely_ overwriting the
memory can allow this old data to be leaked when the `Buffer` memory is read.

While there are clear performance advantages to using
[`Buffer.allocUnsafe()`](https://nodejs.org/api/buffer.html#static-method-bufferallocunsafesize), extra care _must_ be taken in order to avoid
